...
namespace TheMazeGame.Models
{
    ...
    public class GameField : IGameSerialization
    {
        ...
        private Cell CreateCoinCell()
        {
            ...
            {
                ColorBackground = ConsoleColor.Red,
                ColorForeground = ConsoleColor.DarkYellow,
        ...
        private Cell CreateClosedDoorCell()
        {
            var cell = new Cell
            {
                ColorBackground = ConsoleColor.Cyan,
                ColorForeground = ConsoleColor.Black,
        ...
        private Cell CreateKeyCell()
        {
            ...
            {
                ColorBackground = ConsoleColor.Red,
                ColorForeground = ConsoleColor.DarkCyan,
        ...
        private Cell CreatePortalCell()
        {
            var cell = new Cell()
            {
                ColorBackground = ConsoleColor.Magenta,
                ColorForeground = ConsoleColor.White,
        ...
        private Cell CreatePrizeCell()
        {
            var cell = new Cell()
            {
                ColorBackground = ConsoleColor.White,
        ...
        private void SetCellStyle(GameObject gameObject, FieldTypes fieldType)
        {
            ...
            switch (fieldType)
            {
                case FieldTypes.Route:
                    ...
                    gameObject.ColorBackground = ConsoleColor.Red;
                    gameObject.Symbol = ' ';
                    break;
                case FieldTypes.Coin:
                    gameObject.ColorForeground = ConsoleColor.DarkYellow;
                    gameObject.ColorBackground = ConsoleColor.Red;
                    gameObject.Symbol = 'o';
                    break;
                ...
                case FieldTypes.ClosedDoor:
                    gameObject.ColorForeground = ConsoleColor.Black;
                    gameObject.ColorBackground = ConsoleColor.Cyan;
                    gameObject.Symbol = 'D';
                    break;
                case FieldTypes.Key:
                    gameObject.ColorForeground = ConsoleColor.DarkCyan;
                    gameObject.ColorBackground = ConsoleColor.Red;
                    gameObject.Symbol = 'k';
                    break;
                case FieldTypes.Trap:
                case FieldTypes.DeadlyTrap:
                    gameObject.ColorForeground = ConsoleColor.DarkRed;
                    gameObject.ColorBackground = ConsoleColor.Red;
                    gameObject.Symbol = 'x';
                    break;
                case FieldTypes.Portal:
                    gameObject.ColorForeground = ConsoleColor.White;
                    gameObject.ColorBackground = ConsoleColor.Magenta;
                    gameObject.Symbol = 'P';
                    break;
                case FieldTypes.Prize:
                    gameObject.ColorForeground = ConsoleColor.Green;
                    gameObject.ColorBackground = ConsoleColor.White;
                    gameObject.Symbol = '*';
                    break;
